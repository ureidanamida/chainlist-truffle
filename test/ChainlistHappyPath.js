...
contract('Chainlist',function(accounts){
  ...
  it("should be initialised with empty values", function(){
    return Chainlist.deployed().then(function(instance){
      ...
      assert.equal(data.toNumber(),0x0,"number of articles must be zero");
  ...
  it("should let us sell a second article", function(){
      ...
      return Chainlist.deployed().then(function(instance){
        ...
        assert.equal(data[0].toNumber(),2,"article id must be one");
        assert.equal(data[1],seller,"seller must be "+ seller);
        assert.equal(data[2],0x0,"buyer must be empty");
  ...
  it("should buy an article",function(){
    return Chainlist.deployed().then(function(instance){
      ...
      // check the effect of the purchase on the account balances of the buyer and the seller, accounting for the effect of gas
      assert(sellerBalanceAfterBuy == sellerBalanceBeforeBuy + articlePrice1, "seller should have received " + articlePrice1 + "Eth");
